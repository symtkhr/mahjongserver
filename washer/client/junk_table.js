...
var Layout = function() {
  ...
  this.update_call_info = function(qplayer, op) {
    ...
    if (jp.is_houki) { 
      var str_flag = "<img src='./haiga/houki.svg' width=30 height=30>";
...
var JangTable = function(){
  ...
  this.apply_tileset = function(tilesets) {
    tilesets.split(";").forEach(q => {
      if (q === "red") this.red_enable = true;
      if (q === "transp") this.transp_enable = true;
      if (q === "notan") this.kuitan_enable = false;
      if (q === "east") this.tonpu = true;
      if (q === "wron") this.double_rong = true;
    });
